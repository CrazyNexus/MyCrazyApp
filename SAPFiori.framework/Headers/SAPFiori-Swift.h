...
/// Inter-item spacing between items in control.  Follows behavior of <code>UIStackView.spacing</code> property.  Defaults to 29.0.
...
@interface FUIAttachmentsFormCell : NibDesignableTableViewCell
...
@interface FUIAttachmentsViewController : UIViewController <QLPreviewControllerDataSource>
...
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified dividerTop;
/// The view serves as bottom divider.
@property (nonatomic, weak) IBOutlet UIView * _Null_unspecified dividerBottom;
...
@interface FUIButtonFormCell : NibDesignableTableViewCell
...
@property (nonatomic, weak) IBOutlet FUIButton * _Null_unspecified button;
/// :nodoc:
- (void)prepareForReuse;
@end
...
@interface FUICollectionViewTableViewCell : NibDesignableTableViewCell
/// <code>UICollectionView</code> subclass, which covers the bounds of the cell.
@property (nonatomic, strong) IBOutlet FUIResizingCollectionView * _Null_unspecified collectionView;
/// Reuse identifier
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull reuseIdentifier;)
+ (NSString * _Nonnull)reuseIdentifier SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
...
/// FUIContactCell is variant of UITableViewCell defined in SAPFiori. It contains a <code>UIImageView</code>, several <code>UILabel</code>s and a <code>FUIActivityControl</code> component.
...
@interface FUIContactCell : NibDesignableTableViewCell
/// Reuse identifier
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull reuseIdentifier;)
+ (NSString * _Nonnull)reuseIdentifier SWIFT_WARN_UNUSED_RESULT;
/// The FUIImageView holds a detail image.
@property (nonatomic, strong) IBOutlet FUIImageView * _Null_unspecified detailImageView;
...
@property (nonatomic, weak) IBOutlet FUIActivityControl * _Null_unspecified activityControl;
...
@interface FUIInlineValidationTableViewCell : NibDesignableTableViewCell
/// :nodoc:
...
/// It will be displayed only when this cell is selected.
@property (nonatomic, weak) IBOutlet UIDatePicker * _Null_unspecified durationPicker;
/// The default cell reuse identifier.
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull reuseIdentifier;)
+ (NSString * _Nonnull)reuseIdentifier SWIFT_WARN_UNUSED_RESULT;
...
/// //This is a must.  Without calling view.layoutSubviews(), the subviews are not initialized. A subview like vc.messageNameLabel is still nil
...
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified messageNameLabel;
/// A message detail label displayed below <code>messageNameLabel</code>
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified messageDetailLabel;
/// A message detail label displayed below <code>messageDetailLabel</code>
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified messageEmphasisLabel;
/// A message detail label displayed below <code>messageEmphasisLabel</code>
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified messageFootnoteLabel;
...
@property (nonatomic, weak) IBOutlet FUIButton * _Null_unspecified messageActionButton;
...
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified titleLabel;
/// :nodoc:
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
@interface FUIKPIView : NibDesignable
/// :nodoc:
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
/// :nodoc:
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
/// Optional label, displayed beneath the KPI components.  Wraps to 2 lines, with a preferred max width of 216 px.
@property (nonatomic, weak) IBOutlet FUILabel * _Null_unspecified captionlabel;
/// :nodoc:
- (void)prepareForInterfaceBuilder;
@end
...
@interface FUIKeyValueCollectionViewCell : NibDesignableCollectionViewCell
/// The UILabel holds the key string.
@property (nonatomic, weak) UILabel * _Null_unspecified keyLabel;
...
@property (nonatomic, strong) IBOutlet UINavigationItem * _Null_unspecified navigationBarTitleItem;
...
@property (nonatomic, weak) IBOutlet FUILoadingIndicatorView * _Null_unspecified loadingIndicator;
...
@property (nonatomic, weak) IBOutlet FUIProcessingIndicatorView * _Null_unspecified processingIndicator;
...
@property (nonatomic, weak) IBOutlet SZTextViewNoteCellExt * _Null_unspecified valueTextView;
...
@interface FUIObjectCollectionViewCell : NibDesignableCollectionViewCell
/// Reuse identifier
...
@interface FUIObjectTableViewCell : NibDesignableTableViewCell
/// Reuse identifier
...
@optional
/// Handling demoButton touch up inside action on a FUIWelcomeScreen view.
/// <ul>
///   <li>
...
/// Handling signInButton touch up inside action on a FUIWelcomeScreen view
/// <ul>
///   <li>
///     _: FUIWelcomeScreen instance
///   </li>
...
+ (FUIPasscodeChangeController * _Nullable)createInstanceFromStoryboard SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)viewDidLoad;
...
+ (NSString * _Nullable)chooseMinGroupsMessageFormat SWIFT_WARN_UNUSED_RESULT;
...
+ (FUIPasscodeCreateController * _Nullable)createInstanceFromStoryboard SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
- (void)viewWillAppear:(BOOL)animated;
...
+ (FUIPasscodeInputController * _Nullable)createInstanceFromStoryboard SWIFT_WARN_UNUSED_RESULT;
/// :nodoc:
- (void)viewDidLoad;
/// :nodoc:
- (void)viewDidAppear:(BOOL)animated;
...
/// Developer can add a <code>FUISearchBarcodeScanner</code> to this <code>FUISearchBar</code> by setting the
...
/// for this <code>FUISearchBar</code> to display the <code>FUISearchBarcodeScanner</code> in function
...
@interface FUISimpleCollectionViewCell : NibDesignableCollectionViewCell
/// Reuse identifier
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull reuseIdentifier;)
+ (NSString * _Nonnull)reuseIdentifier SWIFT_WARN_UNUSED_RESULT;
...
@interface FUISimplePropertyCollectionViewCell : NibDesignableCollectionViewCell
...
/// <code>UITableViewHeaderFooterView</code> reusable view for headers and footers.  API matches that of <code>FUICollectionSectionHeaderFooterView</code>.
...
@interface FUITimelineCell : NibDesignableTableViewCell
/// Reuse identifier
...
@interface FUITimelineMarkerCell : NibDesignableTableViewCell
/// Reuse identifier
...
@property (nonatomic, weak) IBOutlet FUITextField * _Null_unspecified valueTextField;
@property (nonatomic, weak) IBOutlet FUITextField * _Null_unspecified titleTextField;
...
/// Application can implement the <code>FUIOnboardingDelegate</code> protocol, to present the demo mode of the application by adopting with the <code>didSelectDemoMode</code> function and to proceed sign in by implementing the <code>didSelectSignIn</code> function
...
///
///
/// \endcodeNote that the FUIWelcomeScreen is supported for iPad portrait and landscape orientation and iPhone portrait orientation only.
...
@interface FUIWelcomeScreen : UIViewController
...
@property (nonatomic, strong) IBOutlet UILabel * _Null_unspecified welcomeDetailLabel;
...
/// Activate button that only shows when <code>state</code> is set to <code>.isConfigured</code>.  Setting <code>signInButton</code>.setTitle displays your own title for the button on the screen; otherwise, framework displays the default title, <code>Activate</code>.
@property (nonatomic, strong) IBOutlet FUIOnboardingButton * _Null_unspecified signInButton;
...
@property (nonatomic, strong) IBOutlet FUIOnboardingButton * _Null_unspecified demoButton;
/// The <code>FUIOnboardingDelegate</code> implementation.
@property (nonatomic, weak) id <FUIOnboardingDelegate> _Nullable delegate;
/// A flag to indicate demo availability.  Default is true.  Only when it’s true, display <code>Want to explore</code> label and <code>Try the Demo</code> button.
...
/// :nodoc:
SWIFT_CLASS("_TtC8SAPFiori21SZTextViewNoteCellExt")
