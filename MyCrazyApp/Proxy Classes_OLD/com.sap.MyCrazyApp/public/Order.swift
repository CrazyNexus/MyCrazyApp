...
open class Order: EntityValue {
    ...
    open var customer: Customer? {
        get {
            return CastOptional<Customer>.from(self.dataValue(for: Order.customer))
        }
        set(value) {
            self.setDataValue(for: Order.customer, to: value)
        }
    }
    ...
    open var orderDetails: Array<OrderDetail> {
        get {
            return ArrayConverter.convert(EntityValueList.castRequired(self.dataValue(for: Order.orderDetails)).toArray(), Array<OrderDetail>())
        }
        set(value) {
    ...
    open var shipper: Shipper? {
        get {
            return CastOptional<Shipper>.from(self.dataValue(for: Order.shipper))
        }
        set(value) {
            self.setDataValue(for: Order.shipper, to: value)
        }
    }
}
