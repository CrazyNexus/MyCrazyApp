...
class DetailViewController: UITableViewController, Notifier, LoadingIndicator {
    ...
    var northwindEntities: NorthwindEntitiesDataAccess {
        return appDelegate.northwindEntities
    }
    ...
    @IBAction func updateEntity(_ sender: AnyObject) {
        ...
        self.northwindEntities.service.updateEntity(self.tableDelegate.entity) { error in
            self.hideIndicator()
    ...
    func createEntity() {
        ...
        self.northwindEntities.service.createEntity(self.tableDelegate.entity) { error in
            self.hideIndicator()
