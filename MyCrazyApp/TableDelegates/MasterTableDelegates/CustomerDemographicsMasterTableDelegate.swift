//
// CustomerDemographicsMasterTableDelegate.swift
// MyCrazyApp
//
...
class CustomerDemographicsMasterTableDelegate: NSObject, MasterTableDelegate {
    ...
    private var _entities: [CustomerDemographic] = [CustomerDemographic]()
    var entities: [EntityValue] {
        get { return _entities }
        set { self._entities = newValue as! [CustomerDemographic]
        }
    }
    ...
    func requestEntities(completionHandler: @escaping(Error?) -> Void) {
        self.dataAccess.loadCustomerDemographics { (customerdemographics, error) in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let customerdemographic = self.entities[indexPath.row] as! CustomerDemographic
        let cell = cellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CustomerTypeID", value: "\(customerdemographic.customerTypeID)")
        return cell
    }
