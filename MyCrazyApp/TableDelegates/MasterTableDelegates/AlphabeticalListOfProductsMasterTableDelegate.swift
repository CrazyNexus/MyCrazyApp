//
// AlphabeticalListOfProductsMasterTableDelegate.swift
// MyCrazyApp
//
...
class AlphabeticalListOfProductsMasterTableDelegate: NSObject, MasterTableDelegate {
    ...
    private var _entities: [AlphabeticalListOfProduct] = [AlphabeticalListOfProduct]()
    var entities: [EntityValue] {
        get { return _entities }
        set { self._entities = newValue as! [AlphabeticalListOfProduct]
        }
    }
    ...
    func requestEntities(completionHandler: @escaping(Error?) -> Void) {
        self.dataAccess.loadAlphabeticalListOfProducts { (alphabeticallistofproducts, error) in
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let alphabeticallistofproduct = self.entities[indexPath.row] as! AlphabeticalListOfProduct
        let cell = cellWithNonEditableContent(tableView: tableView, indexPath: indexPath, key: "CategoryName", value: "\(alphabeticallistofproduct.categoryName)")
        return cell
    }
